...
namespace PfxBits {
	...
	constexpr DWORD rep   = 0x00000800;
	constexpr DWORD repz  = 0x00001000;
	...
	static inline bool REP  (DWORD n) {return (n & rep  ) != 0;}
	static inline bool REPZ (DWORD n) {return (n & repz ) != 0;}
}
